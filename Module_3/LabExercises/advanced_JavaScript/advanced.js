...
console.log(
  validatedOrderItem("Apple Watch", "AirPods", "Macbook", "iPhone", "iPad")
...
const randomDelay = async () => {
  ...
  try {
    ...
    console.log(`There appears to have been a delay of odd: ${random} seconds.`);
  }
};
randomDelay().then((delay) => {
  delay !== undefined ? console.log(`There appears to have been a delay of even: ${delay} seconds.`) : null;
});
